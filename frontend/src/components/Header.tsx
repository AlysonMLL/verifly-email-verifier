/* O que há aqui:
- Integração com o hook useTheme para identificar o tema atual da aplicação.
- Seleção da versão da logo adequada aos modos claro e escuro.
- Links de navegação para as principais seções da landing page.
- Layout fixo e responsivo com suporte ao desfoque do fundo e ao controle de tema.

Função do arquivo: Renderizar o cabeçalho principal da landing page do Verifly.
Ele reúne a identidade visual, a navegação entre seções e o botão de alternância entre os temas claro e escuro.
*/
    ...
    <header className="fixed inset-x-0 top-0 z-40 w-full h-30 border-b border-slate-200/70 bg-slate-50/85 backdrop-blur-md dark:border-white/5 dark:bg-darkBg/80 transition-colors">
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-12 py-4 md:px-8">
        <div className="flex items-center gap-3">
          <img src={logo} alt="Logo" className="h-14 w-auto transition-all" />
        </div>
